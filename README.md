...
- (1584-1569)/1569*100% = 0,95%
- (72-52)/52*100% = 38,46%
- (30,17-22)/22*100% = 37,13%

Если высчитать среднюю от 3 параметров вычислений, то получаем среднее превосходство  ThreadQueueMaster в 25,51%.
 
*Все результаты получены с использованием кода ThreadPoolBenchmark,
в нем на данный момент редация последних результатов.
